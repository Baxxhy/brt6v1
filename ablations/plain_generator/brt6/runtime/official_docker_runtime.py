...
_TDD_RESET_SEMAPHORE = threading.BoundedSemaphore(
    max(1, int(os.environ.get("BRT_TDD_DOCKER_RESET_WORKERS", "4")))
)
...
class OfficialDockerRuntime:
    ...
    def _execute_candidate(
        ...
        with self._exec_lock:
            ...
            with _TDD_RESET_SEMAPHORE if self.dataset_mode == "tdd" else nullcontext():
