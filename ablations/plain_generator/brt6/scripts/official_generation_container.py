...
def _start_tdd(
    ...
    created_by_invocation = False
    registry = OfficialContainerRegistry()
    preferred_name = spec.get_instance_container_name("brt6persist")
    try:
        resolution = registry.resolve(
            client,
            instance_id=request["instance_id"],
        ...
        return {
            ...
            "image_owned": False,
            "container_persistent": True,
            "container_reused": resolution.reused,
            "container_adopted": resolution.adopted,
            "container_registry": str(registry.path),
